        ...
        echo "</strong></p>";
                 ...
                 //  var_dump($image_control);
                   ...
                   echo     '<div class = "control_fields_checkbox">
                             ...
                             //  var_dump($_GET['control_displayed']); 
                   ...
                   // $control_displayed [] = 'kid';
                    ...
                    echo "</div>";
                    echo ' <input class = "edit_details_submit" type="submit" value="Update Object Details and Return to Add New Gallery Page" alt = "'.$target_kid.'"/>';
                  //  echo '</form>';
