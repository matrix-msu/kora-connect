               ...
               for (var i =0; i < divs.length; i++){
				   ...
				   var chk = [];
				    ...
				    $.ajax({
						...
						data: {"chk": chk, "schemeid" : schemeid, "controlfileds" : controlfileds, "image_control": image_control,"video_control": video_control,"audio_control": audio_control},
